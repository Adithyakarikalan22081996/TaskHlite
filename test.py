...
def pending_task():
    if request.method == "POST":
        ...
        #return redirect(url_for('activity_tracker.html', user=user, Center=Center, Region=Region, Process=Process, Task=Task, Frequency=Frequency))
        return render_template('activity_tracker.html', user=user, Center=Center, Region=Region, Process=Process, Task=Task,
                    Frequency=Frequency)
    else:
...
def activity_tracker():
    if request.method == "POST":
        ...
        # Assuming you have a function named task_status
        note = task_status(user, starttime, endtime, Center, Region, Process, Task, Frequency, Status)

        return redirect(url_for('pending_task.html'))
        ...
        return render_template('activity_tracker.html', user=user, Center=Center, Region=Region, Process=Process, Task=Task, Frequency=Frequency)
